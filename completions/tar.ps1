...
Register-NativeCompleter -Name tar -Parameters @(
    ...
    New-ParamCompleter -ShortName g -LongName listed-incremental -Description $msg.listed_incremental -Type File
    New-ParamCompleter -LongName hole-detection -Description $msg.hole_detection -Arguments "seek", "raw"
    ...
    New-ParamCompleter -LongName level -Description $msg.level -Arguments "0"
    ...
    New-ParamCompleter -LongName occurrence -Description $msg.occurrence -Type FlagOrValue
    New-ParamCompleter -LongName restrict -Description $msg.restrict
    New-ParamCompleter -LongName sparse-version -Description $msg.sparse_version -Arguments "0.0", "0.1", "1.0"
    ...
    New-ParamCompleter -LongName no-overwrite-dir -Description $msg.no_overwrite_dir -Type FlagOrValue
    New-ParamCompleter -LongName one-top-level -Description $msg.one_top_level
    ...
    New-ParamCompleter -LongName to-command -Description $msg.to_command -Type Required

    ## Handling of file attributes
    New-ParamCompleter -LongName atime-preserve -Description $msg.atime_preserve -Type FlagOrValue -Arguments "replace", "system"
    New-ParamCompleter -LongName delay-directory-restore -Description $msg.delay_directory_restore
    New-ParamCompleter -LongName group -Description $msg.group -Type Required
    New-ParamCompleter -LongName group-map -Description $msg.group_map -Type File
    New-ParamCompleter -LongName mode -Description $msg.mode -Type Required
    New-ParamCompleter -LongName mtime -Description $msg.mtime -Type Required
    ...
    New-ParamCompleter -LongName owner -Description $msg.owner -Type Required
    New-ParamCompleter -LongName owner-map -Description $msg.owner_map -Type File
    ...
    New-ParamCompleter -LongName sort -Description $msg.sort -Arguments "none","name","inode"
    ...
    New-ParamCompleter -LongName xattrs-exclude -Description $msg.xattrs_exclude -Type Required
    New-ParamCompleter -LongName xattrs-include -Description $msg.xattrs_include -Type Required

    ## Device selection and switching
    New-ParamCompleter -ShortName f -LongName file -Description $msg.file -Type File
    New-ParamCompleter -LongName force-local -Description $msg.force_local -Type Required
    New-ParamCompleter -ShortName F -LongName info-script, new-volume-script -Description $msg.info_script -Type Required
    New-ParamCompleter -ShortName L -LongName tape-length -Description $msg.tape_length -Type Required
    New-ParamCompleter -ShortName M -LongName multi-volume -Description $msg.multi_volume
    New-ParamCompleter -LongName rmt-command -Description $msg.rmt_command -Type Required
    New-ParamCompleter -LongName rsh-command -Description $msg.rsh_command -Type Required
    New-ParamCompleter -LongName volno-file -Description $msg.volno_file -Type Required

    ## Device blocking
    New-ParamCompleter -ShortName b -LongName blocking-factor -Description $msg.blocking_factor -Type Required
    ...
    New-ParamCompleter -LongName record-size -Description $msg.record_size -Type Required
    ...
    New-ParamCompleter -LongName pax-option -Description $msg.pax_option -Type Required
    ...
    New-ParamCompleter -ShortName I -LongName use-compress-program -Description $msg.use_compress_program -Type Required
    ...
    New-ParamCompleter -LongName add-file -Description $msg.add_file -Type File
    ...
    New-ParamCompleter -ShortName C -LongName directory -Description $msg.directory -Type Directory
    New-ParamCompleter -LongName exclude -Description $msg.exclude -Type Required
    ...
    New-ParamCompleter -LongName exclude-ignore -Description $msg.exclude_ignore -Type Required
    New-ParamCompleter -LongName exclude-ignore-recursive -Description $msg.exclude_ignore_recursive -Type File
    New-ParamCompleter -LongName exclude-tag -Description $msg.exclude_tag -Type File
    New-ParamCompleter -LongName exclude-tag-all -Description $msg.exclude_tag_all -Type File
    New-ParamCompleter -LongName exclude-tag-under -Description $msg.exclude_tag_under -Type File
    ...
    New-ParamCompleter -ShortName K -LongName starting-file -Description $msg.starting_file -Type Required
    New-ParamCompleter -LongName newer-mtime -Description $msg.newer_mtime -Type Required
    ...
    New-ParamCompleter -ShortName N -LongName newer, after-date -Description $msg.newer -Type Required
    ...
    New-ParamCompleter -LongName suffix -Description $msg.suffix -Type Required
    New-ParamCompleter -ShortName T -LongName files-from -Description $msg.files_from -Type File
    New-ParamCompleter -LongName unquote -Description $msg.unquote
    New-ParamCompleter -ShortName X -LongName exclude-from -Description $msg.exclude_from -Type File
    ...
    ## Informative output
    New-ParamCompleter -LongName checkpoint -Description $msg.checkpoint -Type FlagOrValue
    New-ParamCompleter -ShortName R -LongName block-number -Description $msg.block_number
    New-ParamCompleter -LongName totals -Description $msg.totals -Type FlagOrValue -Arguments "SIGHUP","SIGQUIT","SIGINT","SIGUSR1","SIGUSR2"
